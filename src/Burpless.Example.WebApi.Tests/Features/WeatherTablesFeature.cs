...
public class WeatherTablesFeature
{
    ...
    public Task WithTableData() => Scenario.For<WeatherContext>()
        ...
        .And(x => x.TheFollowingDataIsReturned(Table.From(
            new Weather { TemperatureC = 3, Summary = "Freezing", Date = new DateOnly(2024, 12, 25), TemperatureF = 76 },
            new Weather { TemperatureC = 4, Summary = "Bracing", Date = new DateOnly(2024, 12, 26), TemperatureF = 78 })))
